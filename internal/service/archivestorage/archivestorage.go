...
const serviceName = "archivestorage"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Archive Storage", Category: "Storage", Description: "Cold storage for long-term archival", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
