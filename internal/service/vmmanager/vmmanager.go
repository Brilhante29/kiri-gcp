...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "VM Manager", Category: "Compute", Description: "OS patch, config, and inventory management", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
