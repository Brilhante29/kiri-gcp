...
const serviceName = "dataplexcatalog"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Dataplex Catalog", Category: "Analytics & ML", Description: "Unified data governance and cataloging", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
