...
const serviceName = "entityresolution"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Entity Resolution", Category: "Analytics & ML", Description: "Record matching and identity resolution", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
