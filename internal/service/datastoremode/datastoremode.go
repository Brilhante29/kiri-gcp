...
const serviceName = "datastoremode"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Firestore in Datastore Mode", Category: "Databases", Description: "Datastore-compatible Firestore API", State: service.StateBehavioral, Fidelity: service.FidelityB}
}
