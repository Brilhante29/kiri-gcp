...
const serviceName = "firebasehosting"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Firebase Hosting", Category: "Networking", Description: "Static and single-page app hosting with CDN", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
