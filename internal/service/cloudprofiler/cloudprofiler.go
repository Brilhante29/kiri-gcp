...
const serviceName = "cloudprofiler"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Cloud Profiler", Category: "Developer Tools", Description: "Continuous CPU and memory profiling", State: service.StateBehavioral, Fidelity: service.FidelityB}
}
