...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Cloud Trace", Category: "Monitoring & Logging", Description: "Distributed request tracing", State: service.StateBehavioral, Fidelity: service.FidelityA}
}
