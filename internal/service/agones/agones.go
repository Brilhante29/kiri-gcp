...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Agones", Category: "Other Services", Description: "Game server hosting and scaling on GKE", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
