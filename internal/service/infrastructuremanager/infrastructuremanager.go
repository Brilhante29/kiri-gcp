...
const serviceName = "infrastructuremanager"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Infrastructure Manager", Category: "Management & Billing", Description: "Managed Terraform deployments", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
