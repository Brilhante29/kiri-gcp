...
const serviceName = "bigquerystoragewrite"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "BigQuery Storage Write", Category: "Analytics & ML", Description: "High-throughput BigQuery streaming writes", State: service.StateBehavioral, Fidelity: service.FidelityB}
}
