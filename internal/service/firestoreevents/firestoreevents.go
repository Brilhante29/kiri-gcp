...
const serviceName = "firestoreevents"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Firestore Events", Category: "Databases", Description: "Firestore document change triggers", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
