...
const serviceName = "firestoremongodb"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Firestore with MongoDB Compatibility", Category: "Databases", Description: "MongoDB-compatible Firestore API", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
