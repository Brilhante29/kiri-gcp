...
const serviceName = "firestorenative"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Firestore Native Mode", Category: "Databases", Description: "Native-mode Firestore document database", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
