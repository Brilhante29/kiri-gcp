...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Security Token Service", Category: "Security", Description: "Workload identity federation token exchange", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
