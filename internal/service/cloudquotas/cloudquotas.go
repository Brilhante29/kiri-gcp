...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Cloud Quotas", Category: "Management & Billing", Description: "Service quota tracking and adjustment requests", State: service.StateBehavioral, Fidelity: service.FidelityB}
}
