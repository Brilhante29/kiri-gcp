...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "BigLake", Category: "Analytics & ML", Description: "Unified storage engine for lakehouse workloads", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
