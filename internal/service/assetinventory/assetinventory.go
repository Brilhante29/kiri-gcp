...
const serviceName = "assetinventory"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Cloud Asset Inventory", Category: "Management & Billing", Description: "Resource inventory and metadata history", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
