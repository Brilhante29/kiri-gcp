...
const serviceName = "geminicodeassist"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Gemini Code Assist", Category: "Developer Tools", Description: "AI-assisted code completion and review", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
