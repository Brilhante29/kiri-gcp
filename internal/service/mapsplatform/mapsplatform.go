...
const serviceName = "mapsplatform"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Maps Platform", Category: "Other Services", Description: "Maps, routes, and places APIs", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
