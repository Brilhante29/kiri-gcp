...
const serviceName = "storagecontrol"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Storage Control", Category: "Storage", Description: "GCS bucket-level administrative operations", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
