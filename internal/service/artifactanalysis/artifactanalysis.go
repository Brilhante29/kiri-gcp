...
const serviceName = "artifactanalysis"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Artifact Analysis", Category: "Security", Description: "Vulnerability scanning for container images", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
