...
const serviceName = "bigtabledata"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Bigtable Data", Category: "Databases", Description: "Bigtable data-plane read/write API", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
