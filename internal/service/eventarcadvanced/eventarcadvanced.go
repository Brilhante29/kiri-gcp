...
const serviceName = "eventarcadvanced"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Eventarc Advanced", Category: "Application Integration", Description: "Message-bus-based event routing", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
