...
const serviceName = "memorystoreredis"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Memorystore for Redis", Category: "Databases", Description: "Managed Redis caching", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
