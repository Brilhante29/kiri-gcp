...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Cloud CDN", Category: "Networking", Description: "Global content delivery network", State: service.StateBehavioral, Fidelity: service.FidelityA}
}
