...
const serviceName = "developerconnect"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Developer Connect", Category: "Developer Tools", Description: "Source repository connections for CI/CD", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
