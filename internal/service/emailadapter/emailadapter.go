...
const serviceName = "emailadapter"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Email Adapter", Category: "Messaging & Integration", Description: "Outbound transactional email delivery", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
