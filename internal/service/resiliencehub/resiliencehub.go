...
const serviceName = "resiliencehub"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Resilience Hub", Category: "Other Services", Description: "Application resilience assessment", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
