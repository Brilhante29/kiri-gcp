...
const serviceName = "dnsforwarding"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Cloud DNS Forwarding", Category: "Networking", Description: "Hybrid DNS forwarding policies", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
