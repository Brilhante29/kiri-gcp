...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Recommender", Category: "Management & Billing", Description: "Cost, security, and performance recommendations", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
