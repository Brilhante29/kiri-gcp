...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Backup and DR", Category: "Management & Billing", Description: "Centralized backup and disaster recovery", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
