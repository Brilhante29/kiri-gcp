...
const serviceName = "serverlessspark"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Dataproc Serverless for Spark", Category: "Analytics & ML", Description: "Serverless Apache Spark batch workloads", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
