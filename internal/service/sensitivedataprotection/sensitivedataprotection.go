package sensitivedataprotection
...
const serviceName = "sensitivedataprotection"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Sensitive Data Protection", Category: "Security", Description: "Data classification and de-identification (DLP)", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
