...
const serviceName = "appengineflex"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "App Engine Flexible", Category: "Compute", Description: "App Engine flexible environment", State: service.StateBehavioral, Fidelity: service.FidelityB}
}
