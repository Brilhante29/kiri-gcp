...
const serviceName = "apigatewayv2"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "API Gateway v2", Category: "Networking", Description: "API management (v2 API surface)", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
