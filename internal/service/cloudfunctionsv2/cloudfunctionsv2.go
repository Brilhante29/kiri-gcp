...
const serviceName = "cloudfunctionsv2"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Cloud Functions v2", Category: "Compute", Description: "Event-driven serverless functions (2nd gen)", State: service.StateBehavioral, Fidelity: service.FidelityA}
}
