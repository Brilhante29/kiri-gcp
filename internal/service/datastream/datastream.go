...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Datastream", Category: "Analytics & ML", Description: "Serverless change data capture and replication", State: service.StateBehavioral, Fidelity: service.FidelityB}
}
