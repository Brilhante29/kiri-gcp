...
const serviceName = "biglakeiceberg"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "BigLake Iceberg", Category: "Analytics & ML", Description: "Apache Iceberg tables on BigLake", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
