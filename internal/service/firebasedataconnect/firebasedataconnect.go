...
const serviceName = "firebasedataconnect"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Firebase Data Connect", Category: "Databases", Description: "GraphQL API backed by Cloud SQL", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
