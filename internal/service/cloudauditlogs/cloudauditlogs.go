...
const serviceName = "cloudauditlogs"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Cloud Audit Logs", Category: "Monitoring & Logging", Description: "Admin activity and data access audit trail", State: service.StateBehavioral, Fidelity: service.FidelityA}
}
