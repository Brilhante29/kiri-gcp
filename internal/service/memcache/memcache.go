...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Memorystore for Memcached", Category: "Databases", Description: "Managed Memcached caching", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
