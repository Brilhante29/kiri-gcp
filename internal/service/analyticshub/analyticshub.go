...
const serviceName = "analyticshub"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Analytics Hub", Category: "Analytics & ML", Description: "Data exchange and sharing platform", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
