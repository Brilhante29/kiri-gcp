...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "VPC Service Controls", Category: "Security", Description: "Security perimeters around sensitive resources", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
