...
const serviceName = "transferappliance"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Transfer Appliance", Category: "Storage", Description: "Physical data transfer to Cloud Storage", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
