...
const serviceName = "persistentdisk"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Persistent Disk", Category: "Storage", Description: "Block storage for Compute Engine", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
