...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Managed Service for Microsoft AD", Category: "Other Services", Description: "Fully managed Active Directory", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
