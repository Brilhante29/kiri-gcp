...
const serviceName = "snapshotpolicies"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Snapshot Policies", Category: "Storage", Description: "Scheduled persistent disk snapshots", State: service.StateBehavioral, Fidelity: service.FidelityD}
}
