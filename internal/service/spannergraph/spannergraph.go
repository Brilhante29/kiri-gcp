...
const serviceName = "spannergraph"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Spanner Graph", Category: "Databases", Description: "Graph queries over Cloud Spanner", State: service.StateBehavioral, Fidelity: service.FidelityB}
}
