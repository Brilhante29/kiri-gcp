...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "FinSpace", Category: "Other Services", Description: "Financial data management and analytics", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
