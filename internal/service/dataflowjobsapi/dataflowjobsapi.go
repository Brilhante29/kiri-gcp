...
const serviceName = "dataflowjobsapi"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "Dataflow Jobs API", Category: "Analytics & ML", Description: "Dataflow job submission and management", State: service.StateBehavioral, Fidelity: service.FidelityC}
}
