...
const serviceName = "bigquerystorageread"
...
func (s *Service) Meta() service.Meta {
	return service.Meta{Display: "BigQuery Storage Read", Category: "Analytics & ML", Description: "High-throughput BigQuery table reads", State: service.StateBehavioral, Fidelity: service.FidelityB}
}
